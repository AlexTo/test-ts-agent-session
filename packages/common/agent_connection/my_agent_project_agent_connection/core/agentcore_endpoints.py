...
def region_from_gateway_url(gateway_url: str) -> str:
    ...
    if not match:
        raise ValueError(f"Cannot determine region from gateway URL '{gateway_url}'. Pass region explicitly.")
