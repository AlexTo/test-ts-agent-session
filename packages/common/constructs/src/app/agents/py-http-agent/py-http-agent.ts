...
export type PyHttpAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class PyHttpAgent extends Construct implements IGrantable, IConnectable {
  public readonly dockerImage: AgentRuntimeArtifact;
  public readonly agentCoreRuntime: Runtime;

  constructor(scope: Construct, id: string, props?: PyHttpAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/py_agents/docker/py-http-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'PyHttpAgent', {
