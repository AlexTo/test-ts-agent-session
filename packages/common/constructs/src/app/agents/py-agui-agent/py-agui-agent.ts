...
export type PyAguiAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class PyAguiAgent extends Construct implements IGrantable, IConnectable {
  public readonly dockerImage: AgentRuntimeArtifact;
  public readonly agentCoreRuntime: Runtime;

  constructor(scope: Construct, id: string, props?: PyAguiAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/py_agents/docker/py-agui-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'PyAguiAgent', {
