...
export type S3HttpAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class S3HttpAgent extends Construct implements IGrantable, IConnectable {
  public readonly dockerImage: AgentRuntimeArtifact;
  public readonly agentCoreRuntime: Runtime;

  constructor(scope: Construct, id: string, props?: S3HttpAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/agents/bundle/agent/s3-http-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'S3HttpAgent', {
