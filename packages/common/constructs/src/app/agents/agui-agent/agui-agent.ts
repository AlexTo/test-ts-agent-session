...
export type AguiAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class AguiAgent extends Construct implements IGrantable, IConnectable {
  public readonly dockerImage: AgentRuntimeArtifact;
  public readonly agentCoreRuntime: Runtime;

  constructor(scope: Construct, id: string, props?: AguiAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/agents/bundle/agent/agui-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'AguiAgent', {
