...
export type S3A2aAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class S3A2aAgent extends Construct implements IGrantable, IConnectable {
  public readonly dockerImage: AgentRuntimeArtifact;
  public readonly agentCoreRuntime: Runtime;

  constructor(scope: Construct, id: string, props?: S3A2aAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/agents/bundle/agent/s3-a2a-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'S3A2aAgent', {
