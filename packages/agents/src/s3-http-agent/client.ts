...
/**
 * Client for connecting to S3HttpAgent on Bedrock AgentCore Runtime via WebSocket from a NodeJS environment
 *
 * Refer to the Nx Plugin for AWS documentation for instructions to connect to this agent in a browser.
 */
export class S3HttpAgentClient {
  /**
  ...
  /**
   * Creates a tRPC client for use with a locally running S3HttpAgent.
   */
