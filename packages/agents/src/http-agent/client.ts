...
/**
 * Client for connecting to HttpAgent on Bedrock AgentCore Runtime via WebSocket from a NodeJS environment
 *
...
export class HttpAgentClient {
  ...
  /**
   * Creates a tRPC client for use with a locally running HttpAgent.
   */
